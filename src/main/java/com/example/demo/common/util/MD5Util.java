...
public class MD5Util {  
    ...
    /** 
     * 密码验证 
     * @param passwd 	输入的未加密字符串
     * @param dbPasswd 	数据库中保存的已加密字符串
     * @return 
...
//    	System.out.println(encode("JDKJIVU889dsnlejen@3344"));
//		try {
//			String pwd=getEncryptedPwd("JDKJIVU889dsnlejen@3344");
//			System.out.println(pwd);
//			System.out.println(validPasswd("JDKJIVU889dsnlejen@3344", "488FDB02784E6F05666E8C00376CCB4D9AC9D89FF8D5C375A13D1C4BE73CBC"));
//		} catch (NoSuchAlgorithmException e) {
//			e.printStackTrace();
